    ...
    describe "StockMarket module"
        [ describe "Simple market example" <|
              let p1 = "Alice"
                  ...
                  c2 = "Erie"
                  c3 = "B&O"
                  market = { playerOrder = [p1,p2,p3,p4]
                           ...
                           , presidents = Dict.fromList [ (c1, p1)
                                                        , (c2, p2)
                                                        , (c3, p4)]
                           , marketShares = Dict.fromList [ (c2, 3)
                                                          , (c3, 3)]
              ...
              in [ describe "playerCertificateCount"
                 ...
                 , describe "buyShareFromMarket"
                     ...
                     |> Expect.all [ Result.map (\m -> playerStockValue m p1)
                                         >> Expect.equal (Ok 70)
                     ...
                     |> Expect.all [ Result.map (.marketShares >> Dict.get c2)
                                         >> Expect.equal (Ok (Just 2))
